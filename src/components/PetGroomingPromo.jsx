        ...
        >
            ...
            <div className='w-11/12 mx-auto pt-10 flex justify-between md:flex-row flex-col gap-5'>
               ...
               <div className='flex justify-center items-start flex-col'>
                ...
                <h1 className='pet-text text-white text-xl md:text-2xl lg:text-4xl max-w-[450px]'>Transform Your Passion for Pets into a Rewarding Career!</h1>
                <p className='text-lg md:text-xl lg:text-2xl text-white font-bold pet-text1 max-w-[650px]'>Join Enchanting Pets Grooming Academy and master the art of professional pet grooming with expert guidance and hands-on training.</p>
               </div>
               {/* right */}
               <div>

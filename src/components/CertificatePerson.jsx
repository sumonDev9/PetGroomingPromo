    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#0047AB] to-[#73C2FB] py-14 mb-14 relative overflow-hidden">
            ...
            <div className="relative z-10 w-11/12 mx-auto">
                {/* Header */}
                <h1 
                    className="pet-text text-white text-4xl md:text-5xl text-center mb-4 leading-tight"
                    data-aos="fade-down"
                >
                    Get Certified & Start Your Journey Today!
                </h1>
                ...
                {/* Main Grid Layout */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center overflow-hidden max-w-6xl mx-auto">
                    ...
                    {/* Image Section */}
                    <div className="order-1 lg:order-2" data-aos="zoom-in-up" data-aos-delay="300">
                        <img src={CertifiedPerson} className='w-full h-full' alt="CertifiedPerson" />
                    </div>
                </div>
            </div>
